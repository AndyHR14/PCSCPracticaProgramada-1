...
public class PrestamoUrgente extends Prestamo{
   private int duracion;
    // Atributo que define el costo por día de préstamo (525 unidades de moneda por día)
    private int costoPorDia = 525;

    // Constructor de la clase PrestamoUrgente, que llama al constructor de la clase padre Prestamo
    public PrestamoUrgente(Libro libro, Usuario usuario) {
        super(libro, usuario); // Inicializa el préstamo con el libro y el usuario
    }

    // Sobrescribe el método calcularCosto para calcular el costo total del préstamo urgente
    @Override
    ...
    // Método que valida si el préstamo urgente puede realizarse
    ...
    // Método para realizar el préstamo urgente del libro a un usuario
